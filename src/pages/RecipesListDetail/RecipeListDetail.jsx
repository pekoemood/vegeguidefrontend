import { Clock, CookingPot, Leaf, ShoppingCart, User, ChefHat } from "lucide-react";
		...
		<main className="container max-w-screen-lg mx-auto px-8 py-6">
			...
			<div className="mt-4 flex space-x-2 items-center">
				<div className="flex items-center badge badge-secondary">
					<Clock size={20} />
					<span>
						調理時間 : {data.attributes.cooking_time}分
					</span>
				</div>
				<div className="flex items-center badge badge-secondary">
					<ChefHat size={20} />
					<span>
						難易度 : {data.attributes.difficulty}
					</span>
				</div>
				<div className="flex items-center badge badge-secondary">
					<User size={20} />
			...
			<div className="mt-10">
					<button className="btn btn-primary"><ShoppingCart />買い物リストに追加</button>
			</div>
			...
			<div className="w-full mt-10">
					...
					<div>
						{activeTab === "tab1" && (
							<Ingredients servings={data.attributes.servings} ingredients={data.attributes.ingredients}/>
						)}
						{activeTab === "tab2" && (
