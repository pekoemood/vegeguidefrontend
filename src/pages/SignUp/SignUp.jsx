					...
					<div className="w-full max-w-md space-y-8">
						...
						<div className="space-y-6">
							...
							>
								...
								<div className="animate-fade-up" style={{animationDelay: '0.6s', animationFillMode: 'both'}}>
							...
							<div className="text-center text-sm animate-fade-up" style={{animationDelay: '0.65s', animationFillMode: 'both'}}>
								すでにアカウントをお持ちですか？{" "}
								<Link
									to="/login"
