const TermsOfService = () => {
	return (
		<main className="container mx-auto m-10 p-10 space-y-6">
			<div className="space-y-4">
				<h1 className="text-4xl font-bold">利用規則</h1>
				<p>
					この利用規約（以下，「本規約」といいます。）は，VegeGuide（以下，「本サービス」といいます。）を提供する個人開発者（以下，「運営」といいます。）が，本サービスの利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
				</p>
			</div>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第3条（ユーザーIDおよびパスワードの管理）</h2>
				<ul className="list-decimal pl-5 space-y-2">
					<li>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第4条（利用料金および支払方法）</h2>
        <p>現在、本サービスは無料で提供されています。将来的に有料機能を提供する場合には、その内容、料金および支払方法等について、別途本ウェブサイト上で告知します。</p>
			</div>

      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第5条（禁止事項）</h2>
        <p>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第6条（本サービスの提供の停止等）</h2>
				<ul className="list-decimal pl-5 space-y-2">
					<li>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第7条（利用制限および登録抹消）</h2>
				<ul className="list-decimal pl-5 space-y-2">
					<li>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第8条（退会）</h2>
        <p>ユーザーは，運営の定める退会手続により，本サービスから退会できるものとします。退会機能が実装されるまでの間、退会をご希望の場合は、お問い合わせフォームよりご連絡ください。</p>
			</div>

      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第9条（保証の否認および免責事項）</h2>
        <ul className="list-decimal pl-5 space-y-2">
					<li>
						運営は，本サービスに事実上または法律上の瑕疵（安全性，信頼性，正確性，完全性，有効性，特定の目的への適合性，セキュリティなどに関する欠陥，エラーやバグ，権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。
					</li>
					<li>
						運営は，本サービスに起因してユーザーに生じたあらゆる損害について、運営の故意又は重過失による場合を除き、一切の責任を負いません。ただし，本サービスに関する運営とユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合，この免責規定は適用されません。
					</li>
          <li>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第10条（サービス内容の変更等）</h2>
        <p>運営は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
			</div>

      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第11条（利用規約の変更）</h2>
				<ul className="list-decimal pl-5 space-y-2">
					<li>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第12条（個人情報の取扱い）</h2>
        <p>運営は，本サービスの利用によって取得する個人情報については，運営「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
			</div>

      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第13条（通知または連絡）</h2>
      ...
      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第14条（権利義務の譲渡の禁止）</h2>
        <p>ユーザーは，運営の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
			</div>

      <div className="space-y-4">
				<h2 className="text-2xl font-bold">第15条（準拠法・裁判管轄）</h2>
        <ul className="list-decimal pl-5 space-y-2">
					<li>
