	...
	return (
		<main className="container mx-auto m-10 p-10 space-y-6">
			...
			<div className="space-y-4">
				...
				<p>
					現在、本サービスは無料で提供されています。将来的に有料機能を提供する場合には、その内容、料金および支払方法等について、別途本ウェブサイト上で告知します。
				</p>
			</div>
			...
			<div className="space-y-4">
				...
				<p>
					ユーザーは，運営の定める退会手続により，本サービスから退会できるものとします。退会機能が実装されるまでの間、退会をご希望の場合は、お問い合わせフォームよりご連絡ください。
				</p>
			</div>
